                    ...
                    <>
                        ...
                        >
                            <Link to="/my-posts" className="flex items-center gap-3">
                                ...
                                <span className="text-[16px] dark:text-gray-200 group-hover:text-white">My Posts</span>
                            </Link>
                        </DropdownMenuItem>
                        ...
                        {role === "admin" && (
                            ...
                            >
                                <Link to="/user-management" className="flex items-center gap-3">
                                    ...
                                    <span className="text-[16px] dark:text-gray-200 group-hover:text-white">User Management</span>
                                </Link>
                            </DropdownMenuItem>
                        )}
                        ...
                        >
                            ...
                            <span className="text-[16px] dark:text-gray-200 group-hover:text-white">Logout</span>
                        </DropdownMenuItem>
                    </>
                ) : (
                    <>
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-[16px] dark:text-gray-200 group-hover:text-white">Login</span>
                            </Link>
                        </DropdownMenuItem>
                        ...
                        >
                            <Link to="/" className="flex items-center gap-2 ">
                                ...
                                <span className="text-[16px] dark:text-gray-200 group-hover:text-white">Sign up</span>
                            </Link>
                        </DropdownMenuItem>
                    </>
                )}
